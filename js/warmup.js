window.Warmup = {
  ...
  initialize: function () {
     ...
     */
    showNamesForSelector("#under-isaiah-button", "#root > li > ul:nth-child(1) > li > span");

    /*
     Description: show the names of the people under Eulalia
     Outcome: Claude, Lowell
     */
    showNamesForSelector("#under-eulalia-button", "#root > li:nth-child(2) > span:nth-child(1n+2)");
